function rowan2det0 = ImportLandmarks(filename, startRow, endRow)
%IMPORTFILE1 Import numeric data from a text file as a matrix.
%   ROWAN2DET0 = IMPORTFILE1(FILENAME) Reads data from text file FILENAME
%   for the default selection.
%
%   ROWAN2DET0 = IMPORTFILE1(FILENAME, STARTROW, ENDROW) Reads data from
%   rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   rowan2det0 = importfile1('rowan2_det_0.pts', 4, 69);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2014/02/04 18:05:05
