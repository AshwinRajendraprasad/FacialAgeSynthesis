...
%         subplot(1,3,3), imshow(AddZerosToImage(mask, AppearanceParams2Texture(FindModelParameters(AppearanceModel, test_texts(i,:)), AppearanceModel))/255);
        ...
        subplot(1,2,1), imshow(AddZerosToImage(mask, test_texts(i,:), 3)/255);
        subplot(1,2,2), imshow(AddZerosToImage(mask, AppearanceParams2Texture(FindModelParameters(AppearanceModel, test_texts(i,:)), AppearanceModel),3)/255);
    end
