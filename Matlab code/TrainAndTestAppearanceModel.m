function [ AppearanceModel, diff ] = TrainAndTestAppearanceModel( textures, subj_numbers, single_norm_iteration )
...
%   Detailed explanation goes here
    ...
    AppearanceModel = BuildAppearanceModel(train_textures, single_norm_iteration);
    
    diff = TestAppearanceModel(AppearanceModel, test_textures);
