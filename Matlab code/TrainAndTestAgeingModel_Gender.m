...
%   Detailed explanation goes here
    ...
    [AgeingModel_male, diff_male] = TrainAndTestAgeingModel(male_textures, AppearanceModels.Male, subj_numbers(male_inds), subjectlist);
    [AgeingModel_female, diff_female] = TrainAndTestAgeingModel(female_textures, AppearanceModels.Female, subj_numbers(female_inds), subjectlist);
