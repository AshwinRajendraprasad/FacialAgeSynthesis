function [TrainingData, StatisticalModel] = AAMTrainingICA(options)
...
%     % model in options
    ...
    for i = 1:options.PyramidSize
        ...
        [ StatisticalModel(i).SimilarityTransform, StatisticalModel(i).SimilarityParams, StatisticalModel(i).Hessian, StatisticalModel(i).SD ] = PreComputeICA(StatisticalModel(i));        
