function [fps, resDir] = run_biwi_experiment_clm(rootDir, biwiDir, outputDir, verbose, fast, depth, version, varargin)
...
if(fast)
    output = cat(2, output, '_fast');
else
    output = cat(2, output, '_acc');
end
